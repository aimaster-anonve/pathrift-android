...
data class SavedTower(val slotId: Int, val type: String, val level: Int, val totalInvested: Int)
    ...
    fun load(): GameSaveState? {
        return try {
            ...
            val towers = (0 until arr.length()).map { i ->
                ...
                SavedTower(t.getInt("slotId"), t.getString("type"), t.getInt("level"), t.getInt("totalInvested"))
            }
            GameSaveState(
